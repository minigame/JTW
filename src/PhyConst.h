...
#define GROUND_CONTACTTESTBITMASK (PLAYER_CATEGORYBITMASK | ITEM_CATEGORYBITMASK | MONSTER_BULLET_CATEGORYBITMASK)
...
#define MONSTER_BULLET_CONTACTTESTBITMASK (GROUND_CATEGORYBITMASK | PLAYER_CATEGORYBITMASK)

...
#define PLAYER_COLLISIONBITMASK   (GROUND_CATEGORYBITMASK | EDGE_CATEGORYBITMASK | ELEVATOR_CATEGORYBITMASK\
                                    | STONE_CATEGORYBITMASK | FORT_CATEGORYBITMASK)
...
#define GROUND_CONTACTTESTBITMASK (PLAYER_CATEGORYBITMASK | ITEM_CATEGORYBITMASK\
                                   | MONSTER_BULLET_CATEGORYBITMASK )
